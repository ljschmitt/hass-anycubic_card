...
- Current fork release: `v0.2.9`
- Use this fork together with `hass-anycubic_cloud_v3` `v0.2.9`.
...
The card discovers the printer's related entities by device and by stable entity-ID suffixes. For best compatibility, use the same version of this card and `hass-anycubic_cloud_v3`, for example `0.2.9` with `0.2.9`.
