!function (t) {
  ...
  function ri(t, e, i, r) {
    const l = {
      ...
      drying_total_duration: ["drying_total_duration", "trocknung_gesamtdauer"],
      fan_speed: ["fan_speed", "luftergeschwindigkeit"],
      hotbed_temperature: ["hotbed_temperature", "heizbett_temperatur"],
      job_current_layer: ["job_current_layer", "aktuelle_schicht"],
      job_name: ["job_name", "auftragsname"],
      job_preview: ["job_preview", "auftragsvorschau"],
      job_progress: ["job_progress", "auftragsfortschritt"],
      job_speed_mode: ["job_speed_mode", "geschwindigkeitsmodus"],
  ...
  function si(t) {
    for (const e in t) {
      ...
      if ("binary_sensor" === i && r.endsWith("drucker_online")) return r.split("drucker_online")[0];
    }
  }
  function ni(t, e, i, r) {
